...
import 'package:cis_project/app/base_error/base_error.dart';
...
extension DioErrorExtension on DioError {
  ...
  Failure get toFailure {
    _logError(this);
    final error = this;
    final errorData = json.decode(error.response?.data as String);
    final value = BaseError.fromJson(errorData as Map<String, dynamic>);
    ...
    if (useData) {
      final m = errorData['message'] as String?;
